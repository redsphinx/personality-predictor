...
from chainer.initializers import HeNormal, GlorotUniform
from chainer.functions import relu, average_pooling_2d, max_pooling_2d, tanh

# works with MSE and predicting 5 trait numbers
